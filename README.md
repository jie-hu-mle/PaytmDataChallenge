...
This is a home assignment for Paytm.

To run this, you can either use IntelliJ sbt to open the code
or use `sbt package`
then `spark-submit` on your machine in local mode.

To apply on cluster, you need to update the build.sbt files.
And set cluster configurations accordingly.
